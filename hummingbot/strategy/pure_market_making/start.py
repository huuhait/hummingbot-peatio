...
def start(self):
    try:
        ...
        trade_gain_ownside_enabled = c_map.get("trade_gain_ownside_enabled").value
        trade_gain_ownside_allowedloss = c_map.get("trade_gain_ownside_allowedloss").value / Decimal('100')
        trade_gain_careful_enabled = c_map.get("trade_gain_careful_enabled").value
        trade_gain_careful_limittrades = c_map.get("trade_gain_careful_limittrades").value
        ...
        self.strategy = PureMarketMakingStrategy(
            ...
            trade_gain_ownside_enabled=trade_gain_ownside_enabled,
            trade_gain_ownside_allowedloss=trade_gain_ownside_allowedloss,
            trade_gain_careful_enabled=trade_gain_careful_enabled,
            trade_gain_careful_limittrades=trade_gain_careful_limittrades,
