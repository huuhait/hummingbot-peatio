...
class AltmarketsOrderBookTracker(OrderBookTracker):
    ...
    def __init__(self,
        ...
        super().__init__(AltmarketsAPIOrderBookDataSource(trading_pairs), trading_pairs)
    ...
    def data_source(self) -> OrderBookTrackerDataSource:
        if not self._data_source:
            self._data_source = AltmarketsAPIOrderBookDataSource(trading_pairs=self._trading_pairs)
    ...
    async def _track_single_book(self, trading_pair: str):
        ...
        while True:
            try:
                ...
                self.logger().network(
                    "Unexpected error tracking order book for {trading_pair}.",
                    exc_info=True,
