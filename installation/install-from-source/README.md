...
Install [required applications](https://github.com/TheHolyRoger/hummingbot/blob/development/documentation/docs/installation/source/windows.md) before using the script the first time.
