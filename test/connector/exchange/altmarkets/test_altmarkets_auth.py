...
from hummingbot.connector.exchange.peatio.peatio_websocket import PeatioWebsocket
from hummingbot.logger.struct_logger import METRICS_LOG_LEVEL
from hummingbot.connector.exchange.peatio.peatio_constants import Constants
from hummingbot.connector.exchange.peatio.peatio_utils import aiohttp_response_with_errors
...
class TestAuth(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        secret_key = conf.peatio_secret_key
        cls.auth = PeatioAuth(api_key, secret_key)
